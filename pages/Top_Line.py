...
data = pd.DataFrame({
    ...
    "Actual":  [111, 117, 109, 111, 81, 69, 82, 80, 70, 71, 102, 100, 102, 102, 99, 88, 79, 82, 84, 69, 100, 103, 91, 78, 82, 72, 82, 79, 77, 111, 99],
    "MoM":  [108, 110, 116, 100, 70, 81, 80, 70, 69, 80, 111, 112, 109, 105, 102, 92, 98, 83, 72, 92, 89, 89, 69, 85, 79, 73, 78, 83, 70, 110, 87],
    "YoY":  [114, 121, 122, 119, 95, 80, 89, 78, 80, 93, 109, 99, 106, 112, 110, 91, 101, 92, 80, 82, 99, 107, 88, 98, 80, 71, 79, 81, 76, 100, 71]
})
...
data2 = pd.DataFrame({
    ...
    "YoY":  [35, 73, 168, 89, 90, 99, 32, 92, 41, 42, 24, 99]
})
